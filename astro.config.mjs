...
// All 11 locales are indexed (index/follow) and get sitemap + hreflang entries —
...
const locales = ['ru', 'en', 'ko', 'zh', 'ja', 'it', 'de', 'fr', 'tr', 'es', 'pt'];
    ...
    sitemap({
      ...
      i18n: {
        ...
        locales: {
          ...
          it: 'it', de: 'de', fr: 'fr', tr: 'tr', es: 'es', pt: 'pt',
        },
      },
    }),
  ],
