 ...
 *
 * Решение: три наших редакционных мастера, снятых на ОДНОМ И ТОМ ЖЕ синем
 * бархате — постановка с волосами `hair-1600.webp`, кадр инструментов
 * `hair-editorial-alternate-codex-v1.png` и `turmeric-900.webp`. Из них
 * нарезаются восемь разных сюжетов: ампула и пипетка, золотой аппликатор для
 * кожи головы, серебряный поднос с гребнем, пряди волос, волна волос,
 * серебряный гребень, волосы на бархате и корень куркумы у Sunpure. Кадры
 * разные, но серия одна, поэтому страница не рассыпается.
 *
...
/* slug → [мастер, вырез из мастера, подпись для манифеста].
   ...
   История правила — перечисленные здесь кадры УДАЛЕНЫ, в PLAN их нет.
   Сначала за DONGDONGGURIMOO стоял корень солодки — я вывел
