...
const SUPPLIERS = {
  ...
  cayclly: { eyebrow: 'Supplier profile', title: 'CAYCLLY — Korean clean beauty · beer-yeast hair care', accent: '#a8394a' },
  ...
  sprx: { eyebrow: 'Supplier profile', title: 'SPRX — Korean health functional foods for weight control', accent: '#B9616D' },
