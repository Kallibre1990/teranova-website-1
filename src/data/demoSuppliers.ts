/* DEMO suppliers for catalog category pages — FICTIONAL placeholders, clearly
   labelled «Демо» in the UI. All demo cards carry the neutral 'provided' status:
   the 'visited' badge asserts a documented on-site visit and must never appear
   on an invented company. Names are invented (not real brands); contacts are
...
export interface DemoSupplier {
  ...
  status: 'provided' | 'provided'; // -> verify.card_visited/provided
...
export const demoSuppliers: Record<CategoryKey, DemoSupplier[]> = {
  marine: [
    { name: 'Haeyang Marine Supply', initials: 'HM', role: 'maker', status: 'provided', blurb: 0, tags: [0, 1], email: 'demo@haeyang-marine.example', phone: p('1011') },
    ...
    { name: 'Nara Propulsion', initials: 'NP', role: 'maker', status: 'provided', blurb: 1, tags: [2, 5], email: 'demo@nara-propulsion.example', phone: p('1014') },
  ],
  /* Cosmetics now has real verified suppliers (see suppliers.ts) — no demo
     placeholders in this segment. */
  cosmetics: [],
  medical: [
    { name: 'Mirae Medi', initials: 'MM', role: 'maker', status: 'provided', blurb: 0, tags: [0, 3], email: 'demo@mirae-medi.example', phone: p('3011') },
    ...
    { name: 'Haneul MedTech', initials: 'HM', role: 'oem', status: 'provided', blurb: 1, tags: [2, 3], email: 'demo@haneul-medtech.example', phone: p('3014') },
  ],
  industrial: [
    { name: 'Daon CNC', initials: 'DC', role: 'maker', status: 'provided', blurb: 0, tags: [0, 1], email: 'demo@daon-cnc.example', phone: p('4011') },
    ...
    { name: 'Garam Tooling', initials: 'GT', role: 'maker', status: 'provided', blurb: 3, tags: [5, 4], email: 'demo@garam-tooling.example', phone: p('4014') },
  ],
  transport: [
    { name: 'Daero Motors', initials: 'DM', role: 'maker', status: 'provided', blurb: 0, tags: [0, 1], email: 'demo@daero-motors.example', phone: p('5011') },
    ...
    { name: 'Jisan Bus', initials: 'JB', role: 'maker', status: 'provided', blurb: 3, tags: [1, 5], email: 'demo@jisan-bus.example', phone: p('5014') },
  ],
  adjacent: [
    { name: 'Maru Materials', initials: 'MM', role: 'maker', status: 'provided', blurb: 0, tags: [0, 5], email: 'demo@maru-materials.example', phone: p('6011') },
    ...
    { name: 'Nuri Tech', initials: 'NT', role: 'maker', status: 'provided', blurb: 0, tags: [4, 3], email: 'demo@nuri-tech.example', phone: p('6014') },
  ],
  chemical: [
    { name: 'Cheonggu Chem', initials: 'CC', role: 'maker', status: 'provided', blurb: 0, tags: [0, 1], email: 'demo@cheonggu-chem.example', phone: p('7011') },
    ...
    { name: 'Boram Chemical', initials: 'BC', role: 'maker', status: 'provided', blurb: 3, tags: [0, 5], email: 'demo@boram-chemical.example', phone: p('7014') },
  ],
};
