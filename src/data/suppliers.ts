  ...
  },
{
    ...
    /* Знаков не ставим. Нотификации CPNP у нас на руках, но это уведомление, а не
       сертификат; клинические испытания по glAHAssy идут текстом со ссылкой на компанию.
  ...
  },
{
    ...
    /* Каталог прочитан со сканов четырёх брошюр компании: текстового слоя в них
       нет, названия и объёмы сняты со сводных страниц линеек. Объёмы 3D Powder
       Blusher (5 г) и Alaska Aqua Hyaluron Serum (40 мл) подтверждены компанией
       07.09.2026 — прежнее расхождение со сводными страницами снято.
    ...
    /* Компанейского знака не ставим: письмо Lauren от 15.09.2026 называет CPNP
       для десяти конкретных позиций Honey Bee — маркировка перенесена в
       joycos.catalog.json (certs у каждой из десяти карточек), функциональная
       маркировка KFDA
       и веганская пометка Magic Lash заявлены компанией и видны в её каталогах.
       Всё это идёт текстом с указанием источника. */
    certs: [],
    /* Прайс на витрине не публикуем: условия покупатель получает на стадии сделки. */
    gallery: [
      '/img/suppliers/joycos/gallery/huksamsoo-pdrn-shot.jpg',
  ...
  },
{
  ...
  },
  {
    ...
    /* Знаки с их бренд-буклета. Копии документов приходят на стадии сделки, поэтому в
  ...
  },
  {
    ...
    /* Каталог собран по их бренд-презентации ENG2026 от 07.09.2026. Вес Three
       ...
       прямом ответе на прямой вопрос), CEO 윤욱 подтвердил письменно
