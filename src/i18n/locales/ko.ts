...
export const ko: UIDict = {
  ...
  about_home: {
    ...
    body: 'Teranova는 한국에서 제조사를 발굴하고 — 창업자의 공장 직접 방문까지 — 검증하며, 첫 문의부터 화물 수령까지 거래를 진행합니다. 중개 사슬 대신 책임지는 파트너 한 곳.',
  ...
  pages: {
    ...
    verify: {
      ...
      visit_body: '창업자가 생산 현장을 찾아 경영진을 만나고 라인을 점검하며 날짜가 포함된 사진으로 방문을 기록합니다. ‘검증 완료 — 현장 방문’ 상태는 말이 아니라 사실로 뒷받침됩니다.',
