...
const tr: DeepPartial<UIDict> = {
  ...
  about_home: {
    ...
    photo_caption: "Bizzat yapılan ziyaretlerden fotoğraflar: bir kısmı Teranova tarafından çekildi, bir kısmı görüşmelerden sonra üreticiler tarafından sağlandı.",
    label_maker: "Bizzat ziyaret · şirket fotoğrafı",
